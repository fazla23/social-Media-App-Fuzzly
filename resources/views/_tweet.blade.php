<div class="flex p-4 {{$loop->last ?'': 'border-b border-b-gray-500'}} ">
        ...
        <div class="flex">
            <form action="/tweets/{{$tweet->id}}/like" method="post">
                ...
                <div class="flex items-center mr-4">
                    <svg viewBox="0 0 20 20" class="text-blue-500 mr-1 w-3">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" class="fill-current">
            ...
            <form action="/tweets/{{$tweet->id}}/like" method="post">
                ...
                <div class="flex items-center">
                    <svg viewBox="0 0 20 20" class=" {{$tweet->isDislikedBy( auth()->user()) ? 'text-red-800' : 'text-red-300'}}  mr-1 w-3 mt-1">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" class="fill-current">
                            <g id="icon-shape">
